            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Phonic Coach + Project Slate + Plugo Link
                </p>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-baseline">
                  <span className="text-2xl font-bold">₹7,149</span>
                  <span className="ml-2 text-lg text-gray-500 line-through">
                    ₹9,999
                  </span>
                  <span className="ml-2 text-sm text-green-600">28% off</span>
                </div>
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-start">
                  ...
                  <p className="ml-3">
                    Plugo Count - An interactive math learning kit to build
                    arithmetic, logic, and problem-solving skills.
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 mt-1">
                  ...
                  <p className="ml-3">
                    Plugo Letters - An interactive English learning kit to build
                ...
                <div className="flex items-start">
                  ...
                  <p className="ml-3">
                    Plugo Link - An interactive coding kit to learn coding,
                ...
                <div className="flex items-start">
                  ...
                  <p className="ml-3">
                    Free shipping across India for orders above ₹499
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 gap-4 py-4">
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <span className="text-xs">30 Days Return</span>
                </div>
                <div className="flex flex-col items-center text-center">
                  <div className="h-12 w-12 rounded-full bg-yellow-400 flex items-center justify-center mb-2">
                    <Image
                  ...
                  <span className="text-xs">6 Months Warranty</span>
                </div>
                <div className="flex flex-col items-center text-center">
                  <div className="h-12 w-12 rounded-full bg-yellow-400 flex items-center justify-center mb-2">
                    <Image
